...
urlpatterns = [
    ...
    path("agents/status/", agents_status, name="agents_status"),
    path("text-generators/status/", text_generators_status, name="text_generators_status"),
